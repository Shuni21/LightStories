...
function Album({ setSection }) {
  ...
  return (
    <div className="album__container"> {/* Внешний контейнер  */}

      <div className="album__wrapper"> {/* все элементы */}
      ...
      <div className="album__rectangle-container"> {/* Контейнер с фото*/}
        <div className="album__rectangle">
          <div className="album__rectangle-content">
              <div className="photo"></div>
              <div className="photo_name">Название</div>
          </div>
        </div>
      </div>
    </div>
